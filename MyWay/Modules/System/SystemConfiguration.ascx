...
<ext:Hidden runat="server" ID="hdfLogoCongTy" />
<ext:Window runat="server" Title="Chọn ảnh" Resizable="false" Icon="ImageAdd" Hidden="true"
    ...
    <Items>
        <ext:FormPanel runat="server" Border="false" ID="frmPanelUploadImage">
            <Items>
                <ext:Hidden runat="server" Text="~/Modules/System/AttackFile" ID="hdfImageFolder" />
    ...
    <Listeners>
        ...
        <Hide Handler="#{fufUploadControl}.reset();#{hdfImageFolder}.reset();" />
    </Listeners>
</ext:Window>
            ...
            <Items>
                <ext:Panel runat="server" ID="pnlGeneralInformation" Title="Thông tin chung" AnchorHorizontal="100%"
                    ...
                    <Items>
                        ...
                        <ext:Container ID="Container9" runat="server" Height="100" Layout="ColumnLayout">
                            <Items>
                                <ext:Container ID="Container10" runat="server" Layout="FormLayout" ColumnWidth="0.35">
                                    <Items>
                                    </Items>
                                </ext:Container>
                                <ext:Container ID="Container11" runat="server" Layout="FormLayout" ColumnWidth="0.3">
                                    <Items>
                                        <ext:ImageButton ID="imgLogoCongTy" OverImageUrl="~/Modules/System/AttackFile/Logo.png"
                                            ImageUrl="~/Modules/System/AttackFile/Logo.png" runat="server" Width="110"
                                            Height="110">
                                            <Listeners>
                                ...
                                <ext:Container ID="Container12" runat="server" Layout="FormLayout" ColumnWidth="0.3">
                                    <Items>
                                    </Items>
                                </ext:Container>
                            </Items>
