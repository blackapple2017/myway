...
<ext:Window runat="server" ID="wdSetupLayout" Title="Cài đặt bố cục" AutoHeight="true"
                        ...
                        <ext:Panel runat="server" ID="pnlFormGroupDetail" Header="true" Title="Chi tiết nhóm"
                            ...
                            <TopBar>
                                <ext:Toolbar ID="Toolbar2" runat="server">
                                    <Items>
                                        <ext:Button runat="server" ID="btnSaveFormGroupInformation" Icon="Disk" Text="<%$ Resources:Language, update%>">
                                            <DirectEvents>
    ...
    <Buttons>
        ...
        <ext:Button ID="btnCloseSetupLayout" runat="server" Text="<%$ Resources:CommonMessage, Close%>" Icon="Decline">
            <%--<Listeners>
...
<ext:Window runat="server" Title="Cấu hình Form" Modal="true" Width="320" Hidden="true"
    ...
    <Buttons>
        <ext:Button runat="server" Text="<%$ Resources:Language, update%>" Icon="Disk" ID="btnUpdateConfig">
            <DirectEvents>
        ...
        <ext:Button runat="server" Icon="Decline" Text="<%$ Resources:CommonMessage, Close%>" ID="wdConfigWindow_btnCancel">
            <%--<Listeners>
...
<ext:Window runat="server" ID="WdUpdateHtmlConfig" Title="Cấu hình HTML Control"
    ...
    <Buttons>
        <ext:Button runat="server" Text="<%$ Resources:Language, update%>" Icon="Disk" ID="btnUpdateHtmlConfig">
            <DirectEvents>
...
<ext:Window runat="server" Title="Cấu hình các thành phần trên form" Icon="Cog" Hidden="true"
    ...
    <TopBar>
        <ext:Toolbar ID="Toolbar3" runat="server">
            <Items> 
                ...
                <ext:Button runat="server" Icon="Zoom" Text="<%$ Resources:Language, search%>" ID="btnSearchField">
                    <Listeners>
        ...
        <ext:GridPanel Border="true" runat="server" StoreID="StoreFieldInfo" Height="450"
            ...
            <Plugins>
                <ext:RowEditor ID="RowEditor1" ErrorSummary="false" runat="server" CancelText="Hủy"
                    SaveText="<%$ Resources:Language, update%>">
                </ext:RowEditor>
            </Plugins>
            <SelectionModel>
    ...
    <Buttons>
        <ext:Button runat="server" Icon="Decline" Text="<%$ Resources:CommonMessage, Close%>" ID="BtnClosewdConfigElement">
            <%--<Listeners>
