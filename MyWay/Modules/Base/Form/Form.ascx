...
<ext:FormPanel runat="server" ID="frmControl" Padding="6" Border="true" Cls="form"
    ...
    <TopBar>
        <ext:Toolbar ID="ToolBarControl" runat="server">
            <Items>
                <ext:Button runat="server" Icon="Disk" ID="btnUpdate" Text="<%$ Resources:Language, update%>">
                    <DirectEvents>
...
<ext:Window runat="server" Padding="0" ID="wdWindow" Hidden="true" Border="false"
    ...
    <Buttons>
        <ext:Button runat="server" Icon="Disk" Visible="true" ID="wdBtnUpdate" Text="<%$ Resources:Language, update%>">
            <DirectEvents>
                <Click OnEvent="btnUpdate_Click">
                    <EventMask ShowMask="true" Msg="<%$ Resources:Language, updating%>" />
                </Click>
        ...
        <ext:Button runat="server" ID="btnAddNewAndClose" Visible="true" Icon="Disk" Text="<%$ Resources:Language, update_close%>">
            <Listeners>
...
<ext:Window runat="server" Title="Chọn ảnh" Resizable="false" Icon="ImageAdd" Hidden="true"
    ...
    <Buttons>
        ...
        <ext:Button ID="Button1" runat="server" Text="<%$ Resources:CommonMessage, Close%>" Icon="Decline">
            <Listeners>
