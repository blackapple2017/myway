...
public class rp_austfeed_DS_LaoDongThamGiaBHXH : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private XRTableCell hdCtyXH;
    private XRTableCell hdCtyYT;
    private XRTableCell hdCtyTN;
    private XRLabel xrLabel2;
    private XRTableCell xrTableCell6;
    private XRLabel xrLabel3;
    private XRTable xrTable3;
    private XRTableRow xrTableRow3;
    private XRTableCell hdNVXH;
    private XRTableCell hdNVYT;
    private XRTableCell hdNVTN;
    private XRTableCell xrTableCell11;
    private XRTable xrTable4;
    private XRTableRow xrTableRow4;
    private XRTableCell hdTotalXH;
    private XRTableCell hdTotalYT;
    private XRTableCell hdTotalTN;
    private XRLabel xrLabel4;
    private XRTableCell xrTableCell21;
    private XRLabel xrLabel5;
    private XRTable xrTable5;
    private XRTableRow xrTableRow5;
    private XRTableCell hdTruyThuXH;
    private XRTableCell hdTruyThuYT;
    private XRTableCell hdTruyThuTN;
    private XRTableCell hdTongCong;
    /// <summary>
    ...
    public void BindData(ReportFilter filter)
    {
        ...
        // bind hearder các mức % đóng bh theo quy định mới nhất
        DataTable table = DataController.DataHandler.GetInstance().ExecuteDataTable("sp_LayPhanTramTinhBaoHiemTheoThang", "@Month", "@Year", filter.StartMonth, filter.Year);
        if (table.Rows.Count >0)
        {
            hdNVXH.Text = "BHXH  " + table.Rows[0]["NVBYXH"].ToString().Replace(",00","") + "%";
            hdNVYT.Text = "BHYT  " + table.Rows[0]["NVBHYT"].ToString().Replace(",00", "") + "%";
            hdNVTN.Text = "BHTN  " + table.Rows[0]["NVBHTN"].ToString().Replace(",00", "") + "%";
            hdCtyXH.Text = "BHXH  " + table.Rows[0]["DVBHXH"].ToString().Replace(",00", "") + "%";
            hdCtyYT.Text = "BHYT  " + table.Rows[0]["DVBHYT"].ToString().Replace(",00", "") + "%";
            hdCtyTN.Text = "BHTN  " + table.Rows[0]["DVBHTN"].ToString().Replace(",00", "") + "%";
            hdTotalXH.Text = "BHXH  " + table.Rows[0]["TotalBHXH"].ToString().Replace(",00", "") + "%";
            hdTotalYT.Text = "BHYT  " + table.Rows[0]["TotalBHYT"].ToString().Replace(",00", "") + "%";
            hdTotalTN.Text = "BHTN  " + table.Rows[0]["TotalBHTN"].ToString().Replace(",00", "") + "%";
            hdTruyThuXH.Text = "BHXH  " + table.Rows[0]["TotalBHXH"].ToString().Replace(",00", "") + "%";
            hdTruyThuYT.Text = "BHYT  " + table.Rows[0]["TotalBHYT"].ToString().Replace(",00", "") + "%";
            hdTruyThuTN.Text = "BHTN  " + table.Rows[0]["TotalBHTN"].ToString().Replace(",00", "") + "%";
            hdTongCong.Text = "Cộng " + table.Rows[0]["Total"].ToString() + "% + truy thu";
        }
        ...
        xrBoPhan.DataBindings.Add("Text", DataSource, "TEN_CHUCVU");
        ...
        xrSummary36.Func = SummaryFunc.Sum;
        xrTableCell111.Summary = xrSummary36;
        // tongtien bh 
        ...
        xrSummary37.Func = SummaryFunc.Sum;
        xrTableCell126.Summary = xrSummary37;
        // tổng số lao động
    ...
    private void InitializeComponent()
    {
        ...
        this.hdCtyXH = new DevExpress.XtraReports.UI.XRTableCell();
        this.hdCtyYT = new DevExpress.XtraReports.UI.XRTableCell();
        this.hdCtyTN = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrLabel2 = new DevExpress.XtraReports.UI.XRLabel();
        this.xrTableCell6 = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrLabel3 = new DevExpress.XtraReports.UI.XRLabel();
        this.xrTable3 = new DevExpress.XtraReports.UI.XRTable();
        this.xrTableRow3 = new DevExpress.XtraReports.UI.XRTableRow();
        this.hdNVXH = new DevExpress.XtraReports.UI.XRTableCell();
        this.hdNVYT = new DevExpress.XtraReports.UI.XRTableCell();
        this.hdNVTN = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrTableCell11 = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrTable4 = new DevExpress.XtraReports.UI.XRTable();
        this.xrTableRow4 = new DevExpress.XtraReports.UI.XRTableRow();
        this.hdTotalXH = new DevExpress.XtraReports.UI.XRTableCell();
        this.hdTotalYT = new DevExpress.XtraReports.UI.XRTableCell();
        this.hdTotalTN = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrLabel4 = new DevExpress.XtraReports.UI.XRLabel();
        this.xrTableCell21 = new DevExpress.XtraReports.UI.XRTableCell();
        this.xrLabel5 = new DevExpress.XtraReports.UI.XRLabel();
        this.xrTable5 = new DevExpress.XtraReports.UI.XRTable();
        this.xrTableRow5 = new DevExpress.XtraReports.UI.XRTableRow();
        this.hdTruyThuXH = new DevExpress.XtraReports.UI.XRTableCell();
        this.hdTruyThuYT = new DevExpress.XtraReports.UI.XRTableCell();
        this.hdTruyThuTN = new DevExpress.XtraReports.UI.XRTableCell();
        this.hdTongCong = new DevExpress.XtraReports.UI.XRTableCell();
        ...
        this.xrTable6.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow6});
        this.xrTable6.SizeF = new System.Drawing.SizeF(1128F, 32.58333F);
        ...
        // xrSTT
        // 
        this.xrSTT.Font = new System.Drawing.Font("Times New Roman", 8F);
        ...
        this.xrSTT.Weight = 0.080213922333137413D;
        this.xrSTT.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
        ...
        this.xrHoTen.Weight = 0.39505207704035245D;
        // 
        // xrBoPhan
        // 
        ...
        this.xrBoPhan.Weight = 0.21012845645138256D;
        // 
        // xrSoSo
        // 
        ...
        this.xrSoSo.StylePriority.UseTextAlignment = false;
        this.xrSoSo.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
        this.xrSoSo.Weight = 0.154021196810343D;
        // 
        // xrThoiGianDongBH
        // 
        ...
        this.xrThoiGianDongBH.Weight = 0.11170220682120374D;
        // 
        // xrLuongDongBH
        // 
        ...
        this.xrLuongDongBH.Weight = 0.15227760393255976D;
        // 
        // xrBH_Cty
        // 
        ...
        this.xrTableCell1.Weight = 0.42012512185620177D;
        // 
        // xrTableCell5
        // 
        ...
        this.xrTableCell5.Weight = 0.22277114218237998D;
        // 
        // xrTableCell2
        // 
        ...
        this.xrTableCell2.Text = "Số sổ";
        this.xrTableCell2.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.xrTableCell2.Weight = 0.16328815624203233D;
        // 
        // xrTableCell8
        // 
        ...
        this.xrTableCell8.Weight = 0.11842284733343367D;
        // 
        // xrTableCell10
        // 
        ...
        this.xrTableCell10.Weight = 0.16143968008429768D;
        // 
        // xrTableCell9
        // 
        ...
        // hdCtyXH
        // 
        this.hdCtyXH.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Top | DevExpress.XtraPrinting.BorderSide.Right)
                    | DevExpress.XtraPrinting.BorderSide.Bottom)));
        this.hdCtyXH.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdCtyXH.Name = "hdCtyXH";
        this.hdCtyXH.StylePriority.UseBorders = false;
        this.hdCtyXH.StylePriority.UseFont = false;
        this.hdCtyXH.StylePriority.UseTextAlignment = false;
        this.hdCtyXH.Text = "BHXH 18%";
        this.hdCtyXH.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdCtyXH.Weight = 1D;
        // 
        // hdCtyYT
        // 
        this.hdCtyYT.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdCtyYT.Name = "hdCtyYT";
        this.hdCtyYT.StylePriority.UseFont = false;
        this.hdCtyYT.StylePriority.UseTextAlignment = false;
        this.hdCtyYT.Text = "BHYT 3%";
        this.hdCtyYT.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdCtyYT.Weight = 1D;
        // 
        // hdCtyTN
        // 
        this.hdCtyTN.Borders = ((DevExpress.XtraPrinting.BorderSide)((((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Top)
                    | DevExpress.XtraPrinting.BorderSide.Right)
                    | DevExpress.XtraPrinting.BorderSide.Bottom)));
        this.hdCtyTN.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdCtyTN.Name = "hdCtyTN";
        this.hdCtyTN.StylePriority.UseBorders = false;
        this.hdCtyTN.StylePriority.UseFont = false;
        this.hdCtyTN.StylePriority.UseTextAlignment = false;
        this.hdCtyTN.Text = "BHTN 1%";
        this.hdCtyTN.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdCtyTN.Weight = 1D;
        // 
        // xrLabel2
        // 
        ...
        // hdNVXH
        // 
        this.hdNVXH.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Top | DevExpress.XtraPrinting.BorderSide.Right)
                    | DevExpress.XtraPrinting.BorderSide.Bottom)));
        this.hdNVXH.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdNVXH.Name = "hdNVXH";
        this.hdNVXH.StylePriority.UseBorders = false;
        this.hdNVXH.StylePriority.UseFont = false;
        this.hdNVXH.StylePriority.UseTextAlignment = false;
        this.hdNVXH.Text = "BHXH 8%";
        this.hdNVXH.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdNVXH.Weight = 1.2340399546709158D;
        // 
        // hdNVYT
        // 
        this.hdNVYT.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdNVYT.Name = "hdNVYT";
        this.hdNVYT.StylePriority.UseFont = false;
        this.hdNVYT.StylePriority.UseTextAlignment = false;
        this.hdNVYT.Text = "BHYT 1,5%";
        this.hdNVYT.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdNVYT.Weight = 1.2340399227546768D;
        // 
        // hdNVTN
        // 
        this.hdNVTN.Borders = ((DevExpress.XtraPrinting.BorderSide)((((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Top)
                    | DevExpress.XtraPrinting.BorderSide.Right)
                    | DevExpress.XtraPrinting.BorderSide.Bottom)));
        this.hdNVTN.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdNVTN.Name = "hdNVTN";
        this.hdNVTN.StylePriority.UseBorders = false;
        this.hdNVTN.StylePriority.UseFont = false;
        this.hdNVTN.StylePriority.UseTextAlignment = false;
        this.hdNVTN.Text = "BHTN 1%";
        this.hdNVTN.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdNVTN.Weight = 1.2340399646678542D;
        // 
        // xrTableCell11
        // 
        ...
        // hdTotalXH
        // 
        this.hdTotalXH.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Top | DevExpress.XtraPrinting.BorderSide.Right)
                    | DevExpress.XtraPrinting.BorderSide.Bottom)));
        this.hdTotalXH.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdTotalXH.Name = "hdTotalXH";
        this.hdTotalXH.StylePriority.UseBorders = false;
        this.hdTotalXH.StylePriority.UseFont = false;
        this.hdTotalXH.StylePriority.UseTextAlignment = false;
        this.hdTotalXH.Text = "BHXH 26%";
        this.hdTotalXH.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdTotalXH.Weight = 0.90516291676499339D;
        // 
        // hdTotalYT
        // 
        this.hdTotalYT.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdTotalYT.Name = "hdTotalYT";
        this.hdTotalYT.StylePriority.UseFont = false;
        this.hdTotalYT.StylePriority.UseTextAlignment = false;
        this.hdTotalYT.Text = "BHYT 4,5%";
        this.hdTotalYT.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdTotalYT.Weight = 0.90516286162501514D;
        // 
        // hdTotalTN
        // 
        this.hdTotalTN.Borders = ((DevExpress.XtraPrinting.BorderSide)((((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Top)
                    | DevExpress.XtraPrinting.BorderSide.Right)
                    | DevExpress.XtraPrinting.BorderSide.Bottom)));
        this.hdTotalTN.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdTotalTN.Name = "hdTotalTN";
        this.hdTotalTN.StylePriority.UseBorders = false;
        this.hdTotalTN.StylePriority.UseFont = false;
        this.hdTotalTN.StylePriority.UseTextAlignment = false;
        this.hdTotalTN.Text = "BHTN 2%";
        this.hdTotalTN.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdTotalTN.Weight = 0.90516287008112661D;
        // 
        // xrLabel4
        // 
        ...
        // hdTruyThuXH
        // 
        this.hdTruyThuXH.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Top | DevExpress.XtraPrinting.BorderSide.Right)
                    | DevExpress.XtraPrinting.BorderSide.Bottom)));
        this.hdTruyThuXH.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdTruyThuXH.Name = "hdTruyThuXH";
        this.hdTruyThuXH.StylePriority.UseBorders = false;
        this.hdTruyThuXH.StylePriority.UseFont = false;
        this.hdTruyThuXH.StylePriority.UseTextAlignment = false;
        this.hdTruyThuXH.Text = "BHXH 26%";
        this.hdTruyThuXH.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdTruyThuXH.Weight = 1.1615440881644787D;
        // 
        // hdTruyThuYT
        // 
        this.hdTruyThuYT.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdTruyThuYT.Name = "hdTruyThuYT";
        this.hdTruyThuYT.StylePriority.UseFont = false;
        this.hdTruyThuYT.StylePriority.UseTextAlignment = false;
        this.hdTruyThuYT.Text = "BHYT 4,5%";
        this.hdTruyThuYT.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdTruyThuYT.Weight = 1.1615441299624327D;
        // 
        // hdTruyThuTN
        // 
        this.hdTruyThuTN.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdTruyThuTN.Name = "hdTruyThuTN";
        this.hdTruyThuTN.StylePriority.UseFont = false;
        this.hdTruyThuTN.StylePriority.UseTextAlignment = false;
        this.hdTruyThuTN.Text = "BHTN 2%";
        this.hdTruyThuTN.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdTruyThuTN.Weight = 1.1615440736616645D;
        // 
        // hdTongCong
        // 
        this.hdTongCong.Font = new System.Drawing.Font("Times New Roman", 8F, System.Drawing.FontStyle.Bold);
        this.hdTongCong.Name = "hdTongCong";
        this.hdTongCong.StylePriority.UseFont = false;
        this.hdTongCong.StylePriority.UseTextAlignment = false;
        this.hdTongCong.Text = "Cộng (32.5% +truy thu)";
        this.hdTongCong.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
        this.hdTongCong.Weight = 0.15678417649752433D;
        // 
        // ReportFooter
        // 
        ...
        this.xrTableCell110.Weight = 1.1021654802903238D;
        // 
        // xrTableCell111
        // 
        ...
        this.xrTableCell111.Weight = 0.15227768509633136D;
        // 
        // xrTableCell112
        // 
        ...
        this.xrTableCell125.Weight = 1.1021654802903238D;
        // 
        // xrTableCell126
        // 
        ...
        this.xrTableCell126.Weight = 0.15227768509633136D;
        // 
        // xrTableCell127
        // 
        ...
        this.xrTableCell25.Weight = 1.1021654802903238D;
        // 
        // xrTableCell26
        // 
        ...
        this.xrTableCell26.Weight = 0.15227768509633136D;
        // 
        // xrTableCell27
        // 
        ...
        this.xrTableCell41.Weight = 1.1021654802903238D;
        // 
        // xrTableCell140
        // 
        ...
        this.xrTableCell140.Weight = 0.15227768509633136D;
        // 
        // xrTableCell141
        // 
        ...
        this.xrTableCell154.Weight = 1.1021654802903238D;
        // 
        // xrTableCell155
        // 
        ...
        this.xrTableCell155.Weight = 0.15227768509633136D;
        // 
        // xrTableCell156
        // 
        ...
        this.xrTableCell184.Weight = 1.1021654802903238D;
        // 
        // xrTableCell185
        // 
        ...
        this.xrTableCell185.Weight = 0.15227768509633136D;
        // 
        // xrTableCell186
        // 
        ...
        this.xrTableCell169.Weight = 1.1021654802903238D;
        // 
        // xrTableCell174
        // 
        ...
        this.xrTableCell174.Weight = 0.68484189248863747D;
        // 
        // xrTableCell175
        // 
        ...
        this.xrTableCell95.Weight = 1.1021654802903238D;
        // 
        // xrTableCell96
        // 
        ...
        this.xrTableCell96.Weight = 0.15227768509633136D;
        // 
        // xrTableCell97
        // 
        ...
        this.xrTableCell65.Weight = 1.1021655614540953D;
        // 
        // xrTableCell66
        // 
        ...
        this.xrTableCell66.Weight = 0.15227760393255974D;
        // 
        // xrTableCell67
        // 
        ...
        this.xrTableCell70.Weight = 1.1021655614540953D;
        // 
        // xrTableCell71
        // 
        ...
        this.xrTableCell71.Weight = 0.15227760393255974D;
        // 
        // xrTableCell72
        // 
        ...
        // xrLabel9
        // 
        this.xrLabel9.LocationFloat = new DevExpress.Utils.PointFloat(972.2748F, 454F);
        ...
        this.xrLabel8.LocationFloat = new DevExpress.Utils.PointFloat(971.8121F, 354.1667F);
        ...
        // xrLabel7
        // 
        this.xrLabel7.LocationFloat = new DevExpress.Utils.PointFloat(479.4908F, 454F);
        ...
        this.xrLabel6.LocationFloat = new DevExpress.Utils.PointFloat(479.0282F, 354.1667F);
        ...
        this.GroupHeader1.Controls.AddRange(new DevExpress.XtraReports.UI.XRControl[] {
            this.xrTable7});
        this.GroupHeader1.HeightF = 32.58333F;
        ...
        this.xrTable7.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow7});
        this.xrTable7.SizeF = new System.Drawing.SizeF(1128F, 32.58333F);
        ...
        this.xrTableCell51.Weight = 0.15227759341781211D;
        // 
        // xrTableCell52
        // 
        ...
        this.Bands.AddRange(new DevExpress.XtraReports.UI.Band[] {
            ...
            this.GroupHeader1});
        this.Landscape = true;
        this.Margins = new System.Drawing.Printing.Margins(21, 20, 49, 48);
        this.PageHeight = 827;
        this.PageWidth = 1169;
